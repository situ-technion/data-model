...
# path = 'situ_extension_New/situ_extension/data/temp_raw/'
...
class Model:
    ...
    def get_user_topics(known_interactions):
        ...
        for user in users:
            ...
            for rev in major_revs.index:
                ...
                delta_text = ' '.join([li.replace('+ ', '') for li in d.compare(prev_doc.split(), doc.split()) if li[0] == '+'])
    ...
    def analyze_version_with_users_and_topics(curr_iteration, user_main_topics):
        ...
        print('The current version of the document was created by', last_user_name, ' in ', df['Timestamp'][last_version])
    ...
    #         diff_new, diff_old, inter = compute_entities_delta(old_text, new_text, 50)
            ...
            users_topics_in_diff_new = {t: diff_new[t]*user_topics[t] for t in list(set(diff_new).intersection(set(user_topics)))}
            users_topics_in_diff_old = {t: diff_old[t]*user_topics[t] for t in list(set(diff_old).intersection(set(user_topics)))}
            users_topics_in_inter = {t: inter[t]*user_topics[t] for t in list(set(inter).intersection(set(user_topics)))}
            ...
            if len(diff_new) == 0:
                ...
                print('-- Out of these topics, these are yours: ', str(users_topics_in_diff_new))
            print()
            ...
            if len(diff_old) == 0:
                ...
                print('-- Out of these topics, these are yours: ', str(users_topics_in_diff_old))
            print()
            ...
            if len(inter) == 0:
                ...
                print('-- Out of these topics, these are yours: ', str(users_topics_in_inter))
            print()
